...
import '/pages/thank_you/thank_you_widget.dart';
import '/index.dart';
import 'package:flutter/material.dart';
import 'package:flutter_animate/flutter_animate.dart';
import 'package:provider/provider.dart';
import 'package:text_search/text_search.dart';
import 'verify_word_model.dart';
export 'verify_word_model.dart';

class VerifyWordWidget extends StatefulWidget {
  const VerifyWordWidget({super.key});

  static String routeName = 'VerifyWord';
  static String routePath = '/VerifyWord';

  @override
  State<VerifyWordWidget> createState() => _VerifyWordWidgetState();
}

class _VerifyWordWidgetState extends State<VerifyWordWidget>
    with TickerProviderStateMixin {
  late VerifyWordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerifyWordModel());
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'tq6udsxr' /* Kikongo-Portuguese (Dictionary... */,
            ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '6awb8x7y' /* Write here the word you want t... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
