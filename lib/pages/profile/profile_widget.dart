                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'vr1i81y3' /* Tracker Notifications */,
                              ),
                              textAlign: TextAlign.center,
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'tfu2na8d' /* Notification Settings */,
                                          ),
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
